...
export LoadConfig_allinonecontrollerpsoc1
export _LoadConfig_allinonecontrollerpsoc1
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_allinonecontrollerpsoc1
	lcall	LoadConfigTBL_allinonecontrollerpsoc1_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration allinonecontrollerpsoc1
;
;    Load configuration registers for allinonecontrollerpsoc1.
...
;               CUR_PP
;
_LoadConfig_allinonecontrollerpsoc1:
 LoadConfig_allinonecontrollerpsoc1:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_allinonecontrollerpsoc1_Bank0
    mov     X, <LoadConfigTBL_allinonecontrollerpsoc1_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_allinonecontrollerpsoc1_Bank1
    mov     X, <LoadConfigTBL_allinonecontrollerpsoc1_Bank1
